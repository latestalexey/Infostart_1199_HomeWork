...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"РезультатСложенияДвухЧиселРавен(Парам01)","РезультатСложенияДвухЧиселРавен","Тогда результат сложения двух чисел равен 25.5");
...
Процедура УМеняЕстьПервоеСлагаемоеРавное(Парам01) Экспорт
	...
	Контекст.Вставить("Число1", Парам01);
КонецПроцедуры
...
Процедура УМеняЕстьВтороеСлагаемоеРавное(Парам01) Экспорт
	//Ванесса.ПосмотретьЗначение(Парам01,Истина);
	//ВызватьИсключение "Не реализовано.";
	Контекст.Вставить("Число2", Парам01);
КонецПроцедуры

&НаКлиенте
//Тогда результат сложения двух чисел равен 25.5
//@РезультатСложенияДвухЧиселРавен(Парам01)
Процедура РезультатСложенияДвухЧиселРавен(Парам01) Экспорт
	//Ванесса.ПосмотретьЗначение(Парам01,Истина);
	//ВызватьИсключение "Не реализовано.";
	Если Не Парам01 = Математика.Сложение(Контекст.Число1, Контекст.Число2) Тогда
		ВызватьИсключение "Не верный результат сложения!";
	КонецЕсли;
КонецПроцедуры
